  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-6">
      ...
      <ul>
        ...
        <li>Lift Cabin Flooring and Ceiling, Main Ropes, Motor Machine Main Unit</li>
        <li>Brake Coils, Brake Liners, Travelling Cables, Main Micro Cards, Intercom Systems, Inverters</li>
      </ul>

      <h3 class="section__spareparts">Monthly Service Coverage:</h3>
      <ul>
        <li>Machine Room Cleaning, Machine Room Light Cleaning, Safety Gear Inspection</li>
        <li>Machine Cleaning, Brake Liner Check, Control Panel Maintenance</li>
